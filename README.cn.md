...
[![x-cmd/install — oh-my-openagent Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/oh-my-openagent.svg?lang=zh)](https://x-cmd.com/install/oh-my-openagent)
...
合计: **1,059,874** 行代码（覆盖前 5 种语言、共 **7387** 个文件）。
...
- **最新版本**: `v5.0.0-beta.90` (2026-09-24)
- **最近提交**: 2026-09-24
- **Release 含资产**: 13 个

## 流行度

- **Star**: 69,428 · **Fork**: 5,717 · **开放 issue**: 3,043 · **贡献者**: 327

## 累计统计

- **发布数**: 307 · **已合并 PR**: 3545 · **开放 PR**: 451 · **已关闭 issue**: 2431 · **开放 issue**: 612 · **提交数**: 17784
...
_数据快照: `data/card/260926.yml` · 2026-09-26T05:25:06Z._
